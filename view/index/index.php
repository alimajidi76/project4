...
<div class="row">
    ...
    <div class="small-8 medium-3 small-centered medium-uncentered large-3 large-uncentered columns f-product">
        ...
        <!-- End Sale Tag -->
        <img src="public/default/img/product-list/1.jpg" alt="Product 1" />
        <!-- Product Link -->
    ...
    <div class="small-8 medium-3 small-centered medium-uncentered large-3 large-uncentered  f-product columns">
        ...
        <img src="public/default/img/product-list/2.jpg" alt="Product 1" />
        <!-- Product Link -->
        <div class="product-link text-center">
            <a href="#">محصول بالا</a>
        </div>
    ...
    <div class="small-8 medium-3 small-centered medium-uncentered large-3 large-uncentered columns f-product">
        ...
        <img src="public/default/img/product-list/3.jpg" alt="Product 3" />
        <!-- Product Link -->
        <div class="product-link text-center">
            <a href="#">محصول بالا</a>
        </div>
    ...
    <div class="small-8 medium-3 small-centered medium-uncentered large-3 large-uncentered columns f-product">
        ...
        <img src="public/default/img/product-list/4.jpg" alt="Product 4" />
        <!-- Product Link -->
        <div class="product-link text-center">
            <a href="#">محصول بالا</a>
        </div>
    ...
    <div class="small-8 medium-3 small-centered medium-uncentered large-3 large-uncentered columns f-product">
        ...
        <!-- End Sale Tag -->
        <img src="public/default/img/product-list/5.jpg" alt="Product 5" />
        <!-- Product Link -->
        <div class="product-link text-center">
            <a href="#">محصول بالا</a>
        </div>
    ...
    <div class="small-8 medium-3 small-centered medium-uncentered large-3 large-uncentered  f-product columns">
        ...
        <img src="public/default/img/product-list/6.jpg" alt="Product 6" />
        <!-- Product Link -->
        <div class="product-link text-center">
            <a href="#">محصول بالا</a>
        </div>
